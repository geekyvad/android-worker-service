...
abstract public class HandlerWorker extends HandlerThread implements IWorker
{
  ...
  /**
   * Base implementation creates {@link com.geekyvad.workerservice.HandlerWorker.MessageHandler}.
   * Subclasses may create their own handler but it must be subclass of
   * {@link com.geekyvad.workerservice.HandlerWorker.MessageHandler}.<br>
